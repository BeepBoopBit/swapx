...
pub fn builtin_suggestions() -> Vec<SuggestionDef> {
    vec![
        SuggestionDef {
            name: "cat-to-bat".into(),
            description: "Replace cat with bat for syntax highlighting".into(),
        ...
        SuggestionDef {
            name: "ls-to-eza".into(),
            description: "Replace ls with eza for better file listing".into(),
            detect: DetectCondition {
                bin: Some("eza".into()),
                file: None,
                project: None,
        ...
        SuggestionDef {
            name: "grep-to-rg".into(),
            description: "Replace grep with ripgrep for faster searching".into(),
            detect: DetectCondition {
                bin: Some("rg".into()),
                file: None,
                project: None,
        ...
        SuggestionDef {
            name: "find-to-fd".into(),
            description: "Replace find with fd for simpler syntax".into(),
            detect: DetectCondition {
                bin: Some("fd".into()),
                file: None,
                project: None,
        ...
        SuggestionDef {
            name: "du-to-dust".into(),
            description: "Replace du with dust for better disk usage display".into(),
            detect: DetectCondition {
                bin: Some("dust".into()),
                file: None,
                project: None,
            ...
            prompts: vec![],
            rules: vec![SuggestionRule {
                match_pattern: "du ".into(),
                replace: vec![
                    SuggestionReplacement {
                        label: "use dust".into(),
                        with_value: "dust ".into(),
                        default: true,
                    },
                    SuggestionReplacement {
                        label: "keep original".into(),
